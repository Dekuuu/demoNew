...
import com.example.demo.utils.DBAESUtil;
...
/**
 * 自定义mybatis的拦截器，模仿mybatis的分页插件，拦截setParameter方法，实现查询自动加密对应的字段，插入修改时用到
 */
@Slf4j
// 注入Spring
@Component
...
//            parameterObject = map;
    ...
    private List<String> searchParamAnnotation(ParameterHandler parameterHandler) throws NoSuchFieldException, ClassNotFoundException, IllegalAccessException {
        Class<MybatisDefaultParameterHandler> handlerClass = MybatisDefaultParameterHandler.class;
